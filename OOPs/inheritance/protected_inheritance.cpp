...
// Child class
class Male : protected Human // protected access modifier
{
public:
    string color;
...
int main()
{
    ...
    // anything of the parent class can't be accessed directly now
    ...
    obj1.sleep();
    // obj1.setWeight(10); // now all the public members are protected so they can't be accessed directly
